...
describe('Plant a carrot crop', function() {
  this.timeout(30000)
  let driver
  let vars
  ...
  it('Selected tile should be tilled', async function() {
    ...
    let selected_tile = await driver.findElement(By.id("tile_id_10"));
  ...
  it("Total Earnings should have a value of 75", async function() {
    // 4 | click | css=.till_btn | 
    await driver.findElement(By.css(".till_btn")).click()
    // 5 | click | id=tile_id_10 | 
    await driver.findElement(By.id("tile_id_10")).click()
    ...
    // 8 | click | id=crop_to_plant_btn | 
    await driver.findElement(By.id("crop_to_plant_btn")).click()
    // 9 | verifyText | css=.total_earnings_value | 75
